      ...
      <header className="flex flex-col gap-1.5 border-b border-slate pb-6">
        <div className="flex justify-between items-center">
          ...
          <a
            ...
            className="w-9 h-9 rounded-full border border-slate flex items-center justify-center text-silver hover:text-ink hover:border-ink transition-colors duration-150 bg-fog hover:bg-void"
